    ...
    return(
        <div id="how-to-send-a-tx">
            <div style={styles.content}>
                ...
                <h4 id="tx-input" style={styles.main_color}>{t("tutorial.class1.transactionInput.title")}</h4>
                <p>{t("tutorial.class1.transactionInput.p1")}</p>

                <Cells t={t} query={default_lock_query_option} render_dep={default_lock_query_option}  
                length={4} text={{title: t("tutorial.common.cellOfWallet1"), btn_text: t("tutorial.common.fetchCellOfWallet1")}} 
                ...
                <h4 id="tx-output" style={styles.main_color}>{t("tutorial.class1.transactionOutput.title")}</h4>
                ...
                <Cells t={t} query={default_lock_query_option} render_dep={default_lock_query_option} length={4} 
                text={{title: t("tutorial.common.cellOfWallet1"), btn_text: t("tutorial.common.fetchCellOfWallet1")}} 
                custom_style={{layout_style:{border:'1px solid gray'}}}></Cells>
                ...
                <div style={styles.explain_text}>
                  ...
                  <p> {t("tutorial.class1.transactionOutput.p9")}
                  </p>
                </div>

                <h4 id="sign-a-tx" style={styles.main_color}>{t("tutorial.class1.signTheTransaction.title")}</h4>
                ...
                <Form form_template={raw_tx_template} onSubmit={onRawTxSubmit} btn_text={t("tutorial.common.saveBtnText")} title_text={t("tutorial.class1.buildATransaction.formTitle")}></Form>
                ...
                <p>
                {t("tutorial.class1.generateTxHash.p5")}
                </p>
                ...
                <h4 style={styles.main_color}>{t("tutorial.class1.completeSining.title")}</h4>

                <p id="start-signing">{t("tutorial.class1.completeSining.p1")}</p>

                <Signer t={t} />

                <h4 style={styles.main_color}>{t("tutorial.class1.putBackSignature.title")}</h4>
                ...
                { JSON.stringify(raw_tx) &&
                    <Form form_template={ JSON.stringify(raw_tx, null, 2)} onSubmit={onCompleteTxSubmit} btn_text={t("tutorial.common.saveBtnText")}></Form>
                }
