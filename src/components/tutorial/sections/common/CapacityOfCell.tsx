    ...
    <div key={cell.cell_output.lock.args} style={styles.root}>
      <div style={styles.input_wrap}>
        <input
          ...
          placeholder={t("tutorial.widget.capacityOfCell.inputPlaceHolder")}
          type="text"
          style={styles.input}
        />
      </div>
      <div
        style={{ ...styles.cell_panel, ...props.custom_style }}
      ...
      >
        <div
          style={
            isHover
              ? { ...styles.ball, ...styles.ball_hover, ...ballStatusStyle }
              : { ...styles.ball, ...ballStatusStyle }
          }
        >
          <div style={styles.cell_content}>
            {t("tutorial.widget.capacityOfCell.capacity")} <br />
            <br />
            {totalByteLength} Bytes <br />
            <br />
      ...
      >
        <Fade in={open}>
          <div style={styles.paper}>
            ...
            <CodePiece
              code={JSON.stringify(myCell, null, 2)}
              custom_style={{ padding: "5px", border: "1px solid gray" }}
            />
            ...
            <CodePiece
              code={JSON.stringify(
                {
                  ...{ total: totalByteLength + " Bytes" },
                  ...getCellPropertyByteLength(),
                },
                null,
                2
              )}
