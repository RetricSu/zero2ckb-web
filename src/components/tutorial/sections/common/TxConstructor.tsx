  ...
  return (
    <div style={styles.root}>
          ...
          <div style={styles.input_box}>
            <div style={styles.subtitle}>
              <NeonText
                ...
                custom_style={styles.neon_text_style}
              />
            </div>
            <DragCell2InputBall
              t={t}
              get_contents={handleInputCellChange}
              onClearCall={isClear}
              makeOriginCellHidden={false}
            />
          </div>
        </Grid>
        ...
        <Grid item xs={5}>
          <div style={styles.output_box}>
            ...
            <OutputCreator
              ...
              get_tx_output={handleOutputChange}
            />
          </div>
        </Grid>
      </Grid>
      <Grid container spacing={1}>
        <Grid item xs={6}>
          <FreshButton
            text={t("tutorial.widget.txConstructor.btnTextGen")}
        ...
        <Grid item xs={6}>
          <FreshButton
            text={t("tutorial.widget.txConstructor.btnTextClear")}
            onClick={clearAll}
            custom_style={{
              width: "100%",
              fontSize: "20px",
