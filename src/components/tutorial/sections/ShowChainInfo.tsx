    ...
    return(
        <div>
            ...
            <div style={styles.wide_card} id="hands-on">
                <h1 style={styles.wide_card_title}>{t("tutorial.common.getYourHandDirty.title")}</h1>
            ...
            <div style={styles.content}>
                <div style={styles.explain_text}>
                    ...
                    <ul>
                        <li>{t("tutorial.common.getYourHandDirty.studyAChain.ul1.l1")}</li>
                        <li>{t("tutorial.common.getYourHandDirty.studyAChain.ul1.l2")}</li>
                        <li>{t("tutorial.common.getYourHandDirty.studyAChain.ul1.l3")}</li>
                        <li>{t("tutorial.common.getYourHandDirty.studyAChain.ul1.l4")}</li>
                    </ul>
                    <p>
            ...
            <div style={styles.content}>
                <div style={styles.explain_text}>
                    ...
                    <p> {t("tutorial.common.getYourHandDirty.studyAChain.p11")}
                    </p>
            ...
            <div style={styles.content}>
                ...
                <div style={styles.explain_text}>
                    ...
                    <ul>
                        <li>{t("tutorial.common.getYourHandDirty.studyAChain.ul2.l1")}</li>
                        <li>{t("tutorial.common.getYourHandDirty.studyAChain.ul2.l2")}</li>
                        <li>{t("tutorial.common.getYourHandDirty.studyAChain.ul2.l3")}</li>
                    </ul>
                </div>
                <hr/>
                <p>
