    ...
    <div style={styles.container}>
      <div style={common_styles.clear_path}>
        <div style={{ marginBottom: "20px" }}>
          <FreshButton
            isLoading={isLoading}
            text={t("tutorial.widget.newBlocks.fetchBtnText")}
            onClick={fetchNewBlocks}
            custom_style={{
              width: "100%",
              minHeight: "60px",
              fontSize: "20px",
        ...
        {blocks.length != 0 && (
          <div style={styles.content}>
            <p style={styles.explain_text}>
              {t("tutorial.widget.newBlocks.p1")} <br />
              <br />
              {t("tutorial.widget.newBlocks.p2")}
              <br />
              <br />
              {t("tutorial.widget.newBlocks.p3")}
              <br />
              <br />
              {t("tutorial.widget.newBlocks.p4")}
              <br />
              <br />
              {t("tutorial.widget.newBlocks.p5")}{" "}
              <code style={styles.single_line_code}>input {"=>"} output</code>
              <br />
              <br />
