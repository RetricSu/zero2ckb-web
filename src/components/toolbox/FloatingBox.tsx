    ...
    <div style={styles.root}>
      ...
      <div className="side-menu">
        <div style={{ display: isOpen ? "block" : "none" }}>
          <div>
            <h3 style={styles.main_color}>
              {t("tutorial.widget.toolBox.title")}
            </h3>
            <hr style={styles.hr} />
          </div>
          <ul className="nav">
            <li>
              <a onClick={openQueryCell}>
                <span className="fa">🔎</span>&#160;{" "}
                {t("tutorial.widget.toolBox.queryCellBtnText")}
              </a>
            </li>
            <li>
              <a onClick={openQueryTx}>
                <span className="fa">🔎</span>&#160;{" "}
                {t("tutorial.widget.toolBox.queryTxBtnText")}
              </a>
            </li>
            <li>
              <a onClick={openWallets}>
                <span className="fa">💰</span>&#160;{" "}
                {t("tutorial.widget.toolBox.checkWalletBtnText")}
              </a>
            </li>
            <li>
              <a onClick={openConfig}>
                <span className="fa">⚙️</span>&#160;{" "}
                {t("tutorial.widget.toolBox.checkChainConfigBtnText")}
              </a>
            </li>
            <li>
              <a onClick={openCaculator}>
                <span className="fa">📱</span>&#160;{" "}
                {t("tutorial.widget.toolBox.hexToDecimalBtnText")}
              </a>
            </li>
          </ul>
        </div>
