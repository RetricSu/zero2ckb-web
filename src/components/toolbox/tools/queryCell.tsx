      ...
      <div>
        <div className="form" style={styles.search_bar}>
          <input
            ...
            type="text"
            placeholder={t(
              "tutorial.widget.toolBox.queryCell.inputPlaceHolder"
            )}
          />
      ...
      <div>
        {query && (
          <Cells
            ...
            render_dep={query}
            text={{
              title: t("tutorial.widget.toolBox.queryCell.searchResultTile"),
              btn_text: t("tutorial.widget.toolBox.queryCell.retryBtnText"),
            }}
